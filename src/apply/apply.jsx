...
function Apply() {
  return <>
    ...
    <div style={{display: "flex", justifyContent: "center", marginTop: "3.75rem", marginBottom: "3.75rem", flexDirection : "column", paddingLeft:"1.25rem", paddingRight : "1.25rem"}}>
      ...
      <NumContainer>
      <NumLine><Num src={num1}/><NumTitle>1차 서류 기간&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;2.29(목) 10:00 ~ 3.10(일) 23:59</NumTitle></NumLine>
      <NumLine><Num src={num2}/><NumTitle>1차 합격 발표&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;3.11(월)</NumTitle></NumLine>
      <NumLine><Num src={num3}/><NumTitle>2차 면접 기간&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;3.12(월) ~ 3.15(목)</NumTitle></NumLine>
      <NumLine><Num src={num4}/><NumTitle>최종 합격자 발표&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;3.18(월)</NumTitle></NumLine>
      </NumContainer>
      </Container3>
      ...
      <Container3>
        ...
        <NumLine><Num src={num1}/><NumTitle>정규 세션</NumTitle></NumLine>
        <Chart src={chart}/>
        <NumContainer>
        <NumLine><Num src={num2}/><NumTitle>교내 해커톤&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;5.31 (금)</NumTitle></NumLine>
        <NumLine><Num src={num3}/><NumTitle>중앙 해커톤&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;8.13 (화) ~ 8.14 (수)</NumTitle></NumLine>
        <NumLine><Num src={num4}/><NumTitle>연합 해커톤&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;11월 중</NumTitle></NumLine>
        </NumContainer>
      </Container3>
